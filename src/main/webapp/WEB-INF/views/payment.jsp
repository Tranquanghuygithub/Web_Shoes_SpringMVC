					...
					<div class="grid__column-8">
						<form:form modelAttribute="order"
							...
							<div class="method__shipping">
								<h2>1. Chọn hình thức thanh toán</h2>
								<a></a>

								<c:forEach var="entry" items="${sessionScope.map}">

									<form:radiobutton path="shippingId" value="${entry.key}"
										label="${entry.value}" />
									<br>
								</c:forEach>
								<p style="color: red">
									<form:errors path="shippingId"></form:errors>
								</p>
							...
							<div class="method__payment">
								...
								<br>
								<form:radiobutton path="paymentType"
									value="Thanh toán bằng Paypal" label="Thanh toán bằng Paypal" />
								<p style="color: red">
									<form:errors path="paymentType"></form:errors>
								</p>

							</div>
							<button type="submit" class="btn btn--primary btn__order">Đặt
								Mua</button>
						</form:form>
					</div>
